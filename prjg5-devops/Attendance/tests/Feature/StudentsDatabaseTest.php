...
class StudentsDatabaseTest extends TestCase
{
    ...
    public function test_exists_when_student_insertion(){
        $student_infos = ['name' => 'Bob', 'surname' => 'Sponge'];
    ...
    //     $student_infos = ['id' => -10, 'name' => 'Bob', 'surname' => 'Sponge'];
    ...
    //     $student_infos = ['id' => 12345, 'name' => 'Bob', 'surname' => 'Sponge'];
    //     $student = Student::create($student_infos);
    //     $closure = function() use ($student_infos){ Student::create($student_infos); };
    ...
    //     $student_infos1 = ['id' => 1234, 'name' => 'Bob', 'surname' => 'Sponge'];
    //     $student_infos2 = ['id' => 123456, 'name' => 'Bob', 'surname' => 'Sponge'];
